...
(function(vue) {
  ...
  const PagesIndexIndex = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render], ["__file", "C:/Users/bowie/OneDrive/文档/HBuilderProjects/MyBete/pages/index/index.vue"]]);
  ...
  const b = true, k = "app", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "10.1.2.176",\n        "172.28.128.1"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "C:/Program Files (x86)/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"bowie","spaceId":"mp-5e1c2082-b744-4640-a456-06f1c34724b7","clientSecret":"+LY7STtz0tr9q7f0gztkXg==","endpoint":"https://api.next.bspapp.com"}]') || [];
  let x = "";
  try {
    x = "__UNI__C22508B";
  } catch (e) {
...
详细信息：${s4}`), r3(i3);
  ...
  const _sfc_main = {
    ...
    onLaunch: function() {
      ...
      const user = Ds.importObject("user");
      user.add();
      getApp().globalData.deviceId = uni.getDeviceInfo().deviceId;
    },
    onShow: function() {
  ...
  const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__file", "C:/Users/bowie/OneDrive/文档/HBuilderProjects/MyBete/App.vue"]]);
  function createApp() {
